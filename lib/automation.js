...
class Automation extends Construct {
  ...
  generateTasks(target, InstanceId, bucketName) {
    // start
    const startDocument = new AutomationDocument(this, "Start" + target, {
    ...
    // stop
    const stopDocument = new AutomationDocument(this, "Stop" + target, {
      documentFormat: DocumentFormat.JSON,
    ...
    // backup
    const backupDocument = new AutomationDocument(this, "Backup" + target, {
      documentFormat: DocumentFormat.JSON,
    ...
    // clean
    const cleanDocument = new AutomationDocument(this, "Clean" + target, {
      documentFormat: DocumentFormat.JSON,
    ...
    // restore
    const restoreDocument = new AutomationDocument(this, "Restore" + target, {
      documentFormat: DocumentFormat.JSON,
