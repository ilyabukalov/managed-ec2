  ...
  constructor(scope, id, props) {
    ...
    userData.addCommands(
      ...
      */
      ...
      'chmod -R +x /home/ubuntu/codebase/**/*.sh',
    ...
    props.backupBucket.grantReadWrite(serverRole);
    ...
    new CfnOutput(this, 'sshCommand', {
      value: `ssh ubuntu@${this.instance.instancePublicDnsName}`,
      description: 'The ssh of our instance',
      exportName: 'sshUrl'
    });

    new CfnOutput(this, 'StartInstance', {
      value: `aws ec2 start-instances --instance-ids ${this.instance.instanceId}`,
    });

    new CfnOutput(this, 'StopInstance', {
      value: `aws ec2 stop-instances --instance-ids ${this.instance.instanceId}`,
    });
