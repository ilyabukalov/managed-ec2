...
// folder in ~/
const CODEBASE_FOLDERS = ['firefly', 'zabbix-server'];
...
class S3 extends Construct {
  ...
  constructor(scope, id) {
    ...
    for (let i = 0; i < CODEBASE_FOLDERS.length; i++) {
      const deploymentNew = this.deployCodebase(CODEBASE_FOLDERS[i], codeStorage);
